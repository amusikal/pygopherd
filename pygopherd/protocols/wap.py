...
class WAPProtocol(HTTPProtocol):
    ...
    def canhandlerequest(self):
        ...
        if 'accept' not in list(self.httpheaders.keys()):
            return 0
        ...
        for tryitem in ['x-wap-profile', 'x-up-devcap-max-pdu']:
            if tryitem in list(self.httpheaders.keys()):
                return 1
    ...
    def handlerwrite(self, wfile):
        ...
        while 1:
            ...
            line = line.rstrip()
            if len(line):
                wfile.write(cgi.escape(line.encode()) + b"\n")
            else:
                wfile.write(b"</p>\n<p>")
        wfile.write(b'</p>\n</card>\n</wml>\n')
    ...
    def filenotfound(self, msg):
        ...
        wfile.write(cgi.escape(msg).encode() + b"\n")
        wfile.write(b'</p>\n</card>\n</wml>\n')
